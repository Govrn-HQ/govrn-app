    ...
    try {
      ...
      toast.success(
        <a
          target="_blank"
          rel="noreferrer"
          href={`${this.site}${membership.hash}`}
        >
          Success! Transaction ID: {membership.hash}
        </a>,
        {
          duration: 3500,
          position: "top-right",
      ...
      try {
        ...
        toast.success(
          <a
            target="_blank"
            rel="noreferrer"
            href={`${this.site}${approve.hash}`}
          >
            Success! Transaction ID: {approve.hash}
          </a>,
          {
            duration: 3500,
            position: "top-right",
    ...
    try {
      ...
      toast.success(
        <a
          target="_blank"
          rel="noreferrer"
          href={`${this.site}${ragequit.hash}`}
        >
          Success! Transaction ID: {ragequit.hash}
        </a>,
        {
          duration: 3500,
          position: "top-right",
